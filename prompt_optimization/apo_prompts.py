...
BRACS_multi = '''I'm trying to write a prompt used to generate description for the given image, where the generated description can enhance the image zero-shot classification of breast tumor in the image.
        ...
        '''
BACH = """I'm trying to write a prompt used to generate description for the given image, where the generated description can enhance the image zero-shot classification of breast tumor in the breast cancer histology images.
